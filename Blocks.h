...
namespace PushBoxes {
const BlockType VOID_BLOCK("void", '.', 1, 0, 0, {0});
const BlockType WALL_BLOCK("wall", 'W', 0, 0, 0, {0});
const BlockType BOX_BLOCK("box", 'B', 0, 1, 0, {0});
const BlockType PLAYER_BLOCK("player", '@', 0, 1, 0, {0});
